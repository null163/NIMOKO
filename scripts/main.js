...
function resize() {
  ...
  headHeight = 142 / 659 * windowHeight
  ...
  score2 = 110 / 659 * windowHeight  //left
  ...
  continueWidth = 66 / 659 * windowHeight
  continueTop = 90 / 659 * windowHeight
  continueLeft = 131 / 659 * windowHeight
  ...
  // 重来按钮
  againWidth = 107 / 659 * windowHeight
  againTop = 144 / 659 * windowHeight
  againLeft = 55 / 659 * windowHeight
  ...
  // 最高分
  maxScore1 = 85 / 659 * windowHeight
  maxScore2 = 105 / 659 * windowHeight
  ...
  currentScore2 = 103 / 659 * windowHeight
...
function drawGame() { //打印贴图
  ...
  if (!gameOn && !gameOver) {
    ...
    div.style.left = (snake[0].x * cellSize - 5) / 659 * windowHeight + 'px'
    head.style.width = (cellSize + 10) / 659 * windowHeight + 'px'
